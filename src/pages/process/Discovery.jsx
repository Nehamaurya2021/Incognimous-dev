...
import DiscoveryData from "../../apis/DiscoveryData.json";
...
const DiscoverySection = () => {
  return (
    ...
    <div className='py-20 px-5 sm:px-10 md:px-20 lg:px-[200px]'>
        ...
        <div className="py-5" >
  <img className=" w-full  object-cover h-[600px] rounded-3xl " src="/pro7.png" alt="" />
</div>
      </div>
...
//font-light text-3xl sm:text-[32px]